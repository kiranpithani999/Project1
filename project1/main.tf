...
resource "aws_eip" "nat_eip" {
  ...
  depends_on = [aws_internet_gateway.internet_gate]
...
resource "aws_nat_gateway" "my_nat_gateway" {
  ...
  depends_on = [
    aws_internet_gateway.internet_gate,
    aws_eip.nat_eip
  ]
